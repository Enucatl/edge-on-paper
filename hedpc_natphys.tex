...
but the photon energy is limited
...
conventional X-ray tubes. The method is based on Talbot-Lau interferometry~\cite{Pfeiffer2006} and employs an edge-on approach for the grating design and
arrangement. 
...
The maximum achievable aspect ratios of current fabrication techniques~\cite{David2007,Kenntner2010} are around 60.
