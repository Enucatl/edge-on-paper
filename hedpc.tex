...
\affil{2}{Institute for Biomedical Engineering, Swiss Federal
...
Phase sensitive X-ray imaging provides access to additional information
on the investigated samples with respect to the conventional absorption
radiography and tomography.

Here we show a grating interferometer with a new design of the optical
elements that enables a large field of view and an efficient imaging at
a target energy of~\SI{100}{\kilo\eV} on a conventional tube.
