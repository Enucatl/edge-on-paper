...
\section*{Discussion}
This work develops Talbot-Lau interferometry to a regime of
high photon energies.
High energies are required for the operation of computed
tomography and security scanners, in order to
penetrate materials with large thicknesses or high atomic number.

Additionally, the dose delivered to the patients could be reduced through
phase sensitivity at high energies: the dose depends mainly on the
absorption and it decreases with the third power of the photon energy~\cite{Momose2005}. On
...
We show the first images on a conventional laboratory source in this energy
range. In fig.~\ref{Fig:img_chip}, several resistors and an integrated
circuit are located on different layers on an electronic chip. The
radiographs were acquired in scanning mode, using a step size of
...
imaging to be performed at high energies ($>\SI{100}{\kilo\eV}$) on
conventional X-ray
...
\newblock \emph{\bibinfo{journal}{The Review of scientific instruments}}
  \textbf{\bibinfo{volume}{80}}, \bibinfo{pages}{053701}
  (\bibinfo{year}{2009}).
...
\newblock \emph{\bibinfo{journal}{Japanese Journal of Applied Physics}}
  \textbf{\bibinfo{volume}{44}}, \bibinfo{pages}{6355--6367}
  (\bibinfo{year}{2005}).
